...
<div class="collection_list">
	...
	<li id="third_menu" class="" ><a id="collection_to_backstage"href="<%=resource.getPageUrl(2)%>"><img id="third-button"  src="<%=resource.getImageUrl("collection_backstage.png")%>"onmouseover="this.src='<%=resource.getImageUrl("collection_backstage_r.png")%>'" onmouseout="this.src='<%=resource.getImageUrl("collection_backstage.png")%>'"/></a></li>
	</ul>
</div>
