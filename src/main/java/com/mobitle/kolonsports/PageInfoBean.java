...
public class PageInfoBean implements java.io.Serializable {
    ...
    public void setPage(final int page) {
        switch(page) {
        case 1:
            setValues(page, "collection", "collection", "collection_menu", "collection_bg.jpg");
            break;
        case 2:
    ...
    private void setValues(int page, String name , String contentFileName, String menuFileName) {
        setValues(page, name, contentFileName, menuFileName, "");
    }

    private void setValues(int page, String name , String contentFileName, String menuFileName, String bookImageFileName) {
        this.page = page;
        setName(name);
